...
class EgresoResourceIT {
    ...
    public static Egreso createEntity(EntityManager em) {
        Egreso egreso = new Egreso().fechaCreacion(DEFAULT_FECHA_CREACION).descripcion(DEFAULT_DESCRIPCION).valor(DEFAULT_VALOR);
        return egreso;
    }
    ...
    public static Egreso createUpdatedEntity(EntityManager em) {
        Egreso egreso = new Egreso().fechaCreacion(UPDATED_FECHA_CREACION).descripcion(UPDATED_DESCRIPCION).valor(UPDATED_VALOR);
        return egreso;
    }
    ...
    void createEgreso() throws Exception {
        ...
        assertThat(testEgreso.getValor()).isEqualByComparingTo(DEFAULT_VALOR);
    }
    ...
    void putNewEgreso() throws Exception {
        ...
        updatedEgreso.fechaCreacion(UPDATED_FECHA_CREACION).descripcion(UPDATED_DESCRIPCION).valor(UPDATED_VALOR);
        ...
        assertThat(testEgreso.getValor()).isEqualTo(UPDATED_VALOR);
    }
    ...
    void partialUpdateEgresoWithPatch() throws Exception {
        ...
        partialUpdatedEgreso.descripcion(UPDATED_DESCRIPCION).valor(UPDATED_VALOR);
        ...
        assertThat(testEgreso.getFechaCreacion()).isEqualTo(DEFAULT_FECHA_CREACION);
        assertThat(testEgreso.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
        assertThat(testEgreso.getValor()).isEqualByComparingTo(UPDATED_VALOR);
    }
    ...
    void fullUpdateEgresoWithPatch() throws Exception {
        ...
        partialUpdatedEgreso.fechaCreacion(UPDATED_FECHA_CREACION).descripcion(UPDATED_DESCRIPCION).valor(UPDATED_VALOR);
