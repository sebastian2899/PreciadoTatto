...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).numeroTelefono(DEFAULT_NUMERO_TELEFONO);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).numeroTelefono(UPDATED_NUMERO_TELEFONO);
        return cliente;
    }
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getNumeroTelefono()).isEqualTo(DEFAULT_NUMERO_TELEFONO);
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).numeroTelefono(UPDATED_NUMERO_TELEFONO);
        ...
        assertThat(testCliente.getNumeroTelefono()).isEqualTo(UPDATED_NUMERO_TELEFONO);
    }
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).numeroTelefono(UPDATED_NUMERO_TELEFONO);
